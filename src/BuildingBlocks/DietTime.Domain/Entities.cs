...
public sealed class MealItem : Entity
{
    ...
    public ICollection<MealMedia> Media { get; set; } = [];
...
public sealed class MealMedia : Entity { public Guid MealItemId { get; set; } public MealItem MealItem { get; set; } = null!; public string MediaType { get; set; } = "IMAGE"; public string StorageProvider { get; set; } = "S3"; public string? BucketName { get; set; } public string ObjectKey { get; set; } = ""; public string? PublicUrl { get; set; } public string? ThumbnailObjectKey { get; set; } public string? ThumbnailUrl { get; set; } public string? MimeType { get; set; } public long? FileSizeBytes { get; set; } public int? WidthPixels { get; set; } public int? HeightPixels { get; set; } public bool IsPrimary { get; set; } public int DisplayOrder { get; set; } public string Status { get; set; } = "ACTIVE"; public DateTimeOffset CreatedAt { get; set; } public DateTimeOffset UpdatedAt { get; set; } public Guid? CreatedBy { get; set; } public ICollection<MealMediaTranslation> Translations { get; set; } = []; }
...
public sealed class MealPlanTemplate : Entity { public Guid VersionGroupId { get; set; } public int VersionNumber { get; set; } = 1; public bool IsLatest { get; set; } = true; public Guid? SupersedesId { get; set; } public string Code { get; set; } = ""; public string PlanType { get; set; } = "STANDARD"; public int DurationDays { get; set; } public Guid? CustomerId { get; set; } public bool IsCustomizable { get; set; } public bool IsPublished { get; set; } public bool IsActive { get; set; } public int DisplayOrder { get; set; } public string? ImageUrl { get; set; } public string? IconUrl { get; set; } public DateOnly? ValidFrom { get; set; } public DateOnly? ValidUntil { get; set; } public DateTimeOffset CreatedAt { get; set; } public DateTimeOffset UpdatedAt { get; set; } public Guid? CreatedBy { get; set; } public Guid? UpdatedBy { get; set; } public long RowVersion { get; set; } public ICollection<MealPlanTemplateTranslation> Translations { get; set; } = []; public ICollection<MealPlanTemplateDay> Days { get; set; } = []; public ICollection<MealPlanPrice> Prices { get; set; } = []; }
