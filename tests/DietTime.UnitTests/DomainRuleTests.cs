...
public sealed class DomainRuleTests
{
    ...
    [Fact] public void Price_resolution_honors_paid_upgrade_setting() { Assert.Equal(10m, SelectionRules.ResolveAdditionalPrice(7m, 3m, true)); Assert.Equal(0m, SelectionRules.ResolveAdditionalPrice(7m, 3m, false)); }
