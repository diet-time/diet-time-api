...
public sealed class DomainRuleTests
{
    ...
    [Theory] [InlineData("DRAFT")] [InlineData("PUBLISHED")] [InlineData("ACTIVE")] [InlineData("INACTIVE")] [InlineData("ARCHIVED")] public void Meal_statuses_accept_supported_lifecycle_values(string status) { Assert.True(MealStatuses.IsValid(status)); }
